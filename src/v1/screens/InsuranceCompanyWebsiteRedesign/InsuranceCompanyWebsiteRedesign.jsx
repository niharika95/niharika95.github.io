    ...
    <div className='relative bg-white text-gray-900 font-sans'>
      ...
      <header className='w-full bg-[#A10026]'>
        <ContentContainer className='relative flex flex-col md:flex-row'>
          ...
          <img
            src='/v1/insurance-company-website-design/hero.png'
      ...
      <main className='w-full'>
        ...
        <section className='w-full'>
          <img src='/v1/insurance-company-website-design/foundation.png' alt='Foundation' className='w-full h-auto' />
        </section>
        ...
        <section className='w-full'>
          <img src='/v1/insurance-company-website-design/impact.png' alt='Impact' className='w-full h-auto' />
        </section>
