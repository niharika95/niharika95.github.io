          ...
          <ContentContainer>
            <div className='flex flex-col gap-12'>
              <div className='flex flex-row items-center gap-8'>
                <img
                  src='/v1/admissions-process-acceleration/image 25.png'
                  alt='Step 1 and 2'
              ...
              <div className='flex flex-row items-center gap-8'>
                <img
                  src='/v1/admissions-process-acceleration/image 28.png'
                  alt='Step 3 and 4'
                  className='w-full lg:w-4/5 object-contain'
                />
                <div className='flex-1'>
              ...
              <div className='flex flex-row items-center gap-8'>
                <img
                  src='/v1/admissions-process-acceleration/image 26.png'
                  alt='Step 5 and 6'
                  className='w-full lg:w-4/5 object-contain'
                />
                <div className='flex-1'>
