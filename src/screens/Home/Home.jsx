    ...
    <Gutter className="pt-[100px]">
      ...
      <div id="projects" className="mt-[120px]">
        ...
        <div className="mt-[150px] flex gap-[100px] justify-center items-center flex-row max-[600px]:flex-col">
          <img src={femhealthImg} alt="FemHealth" className="max-w-[600px] max-[600px]:w-full" />
        ...
        <div className="mt-[150px] flex gap-[100px] justify-center items-center flex-row-reverse max-[600px]:flex-col">
          <img src={swiftbikesImg} alt="Swift Bikes" className="max-w-[600px] max-[600px]:w-full" />
          <div className="flex flex-col gap-[20px] text-right items-end">
            <ProjectTitle color="#FF980A">Swift Bikes</ProjectTitle>
            <p className="text-[28px] font-light">An online solution to buying Custom Bikes</p>
            <a
              onClick={() => window.scrollTo({ top: 0 })}
        ...
        {/* Project 3: Svaasthya */}
        <div className="mt-[150px] flex gap-[100px] justify-center items-center flex-row max-[600px]:flex-col">
          <img src={svaasthyaImg} alt="Svaasthya" className="max-w-[600px] max-[600px]:w-full" />
          <div className="flex flex-col gap-[20px] text-left items-start">
            <ProjectTitle color="#1D5D82">Svaasthya</ProjectTitle>
            <p className="text-[28px] font-light">A Support Chatbot for a Hospital in India</p>
            <a
              onClick={() => window.scrollTo({ top: 0 })}
        ...
        <div>
          ...
          <div className="flex flex-col gap-[12px] mt-[60px]">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <Icon color="#106066" icon="clarity:email-solid" />
            ...
            <a
              ...
              rel="noreferrer"
            >
              <Icon color="#106066" icon="akar-icons:linkedin-fill" />
              /niharikadalal
            </a>
            ...
            <a
              ...
              className="font-light text-[20px] no-underline text-black flex gap-[12px] items-center hover:underline"
            >
              <Icon color="#106066" icon="ant-design:file-text-filled" />
              Resume (pdf)
            </a>
          </div>
        </div>
      ...
      <div className="text-center">
        ...
        <div id="recommendations" className="inline-flex mb-[150px] justify-between max-w-[1396px] max-[600px]:block max-[600px]:mb-[100px]">
          {/* Recommendation 1 */}
          <div className="flex w-[45%] text-left max-[600px]:w-full max-[600px]:mb-[80px]">
            <img src={quotesSymbol} alt="quote" className="h-[28px] mr-[12px]" />
            <div>
              <p className="text-[16px] italic font-light mt-0">
              ...
              <div className="flex">
                ...
                <div>
                  <p className="text-[18px] font-normal m-0">Chris Brucker</p>
                  <p className="text-[16px] font-light m-0">Application Engineer | Alstom</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex w-[45%] text-left max-[600px]:w-full max-[600px]:mb-[80px]">
            ...
            <div>
              ...
              <div className="flex">
                <div className="w-[10px] bg-[var(--color-brand-primary)] opacity-20 h-auto mr-[8px]" />
                <div>
                  <p className="text-[18px] font-normal m-0">Ralph Ades</p>
                  <p className="text-[16px] font-light m-0">Director of Automation Tools & Simulators (Retired) | Alstom</p>
                </div>
              </div>
            </div>
          </div>
