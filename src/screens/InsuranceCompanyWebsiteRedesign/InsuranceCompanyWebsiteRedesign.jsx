      ...
      <main className='w-full'>
          ...
          <ContentContainer className='relative z-10'>
            ...
            <div className='flex flex-col gap-12'>
              ...
              <div>
                ...
                <p className='text-lg leading-relaxed mt-8 max-w-[800px]'>Their core problems were clear:</p>
                ...
                <p className='text-lg leading-relaxed mt-4 max-w-[800px]'>Our goal was to create an "out-of-this-world" digital experience that not only solved these issues but also established a new benchmark in the insurance industry, supporting their expansion into new states and their ambitious financial goals.</p>
              </div>
            </div>
          </ContentContainer>
        </section>
          ...
          <ContentContainer>
            <div className='grid md:grid-cols-2 gap-12'>
              <div>
                ...
                <p className='text-lg leading-relaxed mb-4 opacity-90'>We systematically analyzed every page of the existing site against Nielsen's 10 Usability Heuristics.</p>
                <ul className='list-disc list-inside text-lg leading-relaxed space-y-2 opacity-90'>
              ...
              <div>
                ...
                <p className='text-lg leading-relaxed mb-4 opacity-90'>We also conducted an accessibility audit where we used a combination of automated code scanning (Lighthouse), visual review for readability, and manual testing with screen readers.</p>
                <ul className='list-disc list-inside text-lg leading-relaxed space-y-2 opacity-90'>
          ...
          <ContentContainer className='relative z-10'>
            ...
            <div className='flex flex-col gap-12'>
              ...
              <div>
                ...
                <p className='text-lg leading-relaxed mb-6 max-w-[800px]'>The existing site's structure was convoluted. Our process to fix it involved:</p>
                <ul className='space-y-4 text-lg max-w-[800px]'>
        ...
        <section className='py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer>
            ...
            <p className='text-lg leading-relaxed mb-6 max-w-[800px]'>With a solid architectural foundation, we moved into stylistic exploration. We explored four distinct stylistic directions to push the creative boundaries, based on our analysis of competitor websites:</p>
            <ol className='list-decimal list-inside text-lg leading-relaxed space-y-2 mb-6 max-w-[800px]'>
              <li>Friendly & Approachable</li>
              <li>Modern & Sleek</li>
              <li>Futuristic & Tech-Forward</li>
              <li>Playful & Illustrated</li>
            </ol>
            <p className='text-lg leading-relaxed max-w-[800px]'>We presented these themes as mood boards, each with typography pairings and a guide outlining its pros and cons. The client rejected 'Playful' as off-brand and felt 'Futuristic' lacked a human touch. They were drawn to a hybrid of 'Friendly & Approachable' and 'Modern & Sleek', giving us a clear, nuanced direction.</p>
          </ContentContainer>
        </section>
        ...
        <section className='py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer>
            ...
            <p className='text-lg leading-relaxed mb-4 max-w-[800px]'>We wireframed layouts for the home page, exploring multiple versions for each section. This upfront exploration gave us a library of section layouts we could adapt later.</p>
            <p className='text-lg leading-relaxed mb-4 max-w-[800px]'>With the visual style locked in, we designed the remaining pages. To ensure consistency and efficiency, we developed a component-based system.</p>
            <ul className='list-disc list-inside text-lg leading-relaxed space-y-2 max-w-[800px]'>
        ...
        <section className='bg-[#222222] text-white py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer>
            ...
            <p className='text-lg leading-relaxed mt-8 opacity-95 max-w-[800px]'>
        ...
        <section className='py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer>
            ...
            <p className='text-lg leading-relaxed mb-8 max-w-[800px]'>
