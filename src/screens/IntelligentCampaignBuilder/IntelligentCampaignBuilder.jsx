...
const IntelligentCampaignBuilder = () => {
  ...
  const insights = [
    { number: 1, text: "Users needed a clearer, step-by-step process for segmentation." },
    { number: 2, text: "Navigation was cumbersome, requiring too many clicks to access essential campaign assets." },
    { number: 3, text: "The lack of design patterns resulted in a steep learning curve and inconsistent user flows." },
  ];
  const outcomes = [
    { icon: "🚀", title: "Enhanced Usability & Efficiency", text: "By simplifying the UI and clarifying the segmentation workflow, we significantly reduced user friction." },
    { icon: "🎨", title: "Strengthened Brand Presence", text: "The unified visual language and modern UI created a cohesive and trustworthy brand experience." },
    { icon: "⚡", title: "Accelerated Development Cycles", text: "Reusable components enabled faster iteration, streamlined handoffs, and sustained design consistency." },
  ];
      ...
      <main className="w-full">
        ...
        <section className="pl-12 md:pl-24 pr-32 md:pr-64 my-32">
          ...
          <p className="text-lg leading-relaxed">
            ...
            but its complex interface was a significant barrier to speed. This project tackled that challenge
            directly, overhauling the platform to be as intuitive as it was powerful. Through a comprehensive UX
            strategy, we simplified core workflows and established a scalable design system, enabling marketers to
            build targeted campaigns with confidence and efficiency.
          </p>
        </section>
        ...
        <section className="mt-16 grid md:grid-cols-2 gap-24">
          <div className="pl-12 md:pl-24 py-16">
            ...
            <p className="text-lg leading-relaxed mb-4">
              ...
              However, its potential was bottlenecked by a challenging user experience. Marketers, our primary users,
              were struggling to execute core tasks efficiently.
            </p>
            <p className="text-lg leading-relaxed">
              From initial discovery and user feedback, we identified three core problems:
            </p>
            <ul className="list-disc list-inside text-lg leading-relaxed space-y-2 mt-4">
              <li>
                <span className="font-bold">Cognitive Overload:</span> The interface presented too many options
                simultaneously, making it difficult for users to focus and navigate the campaign creation process.
              </li>
              <li>
                <span className="font-bold">Unclear Workflows:</span> The crucial process of segmenting an audience was
                confusing and lacked a clear, guided path, leading to user friction and errors.
              </li>
              <li>
                <span className="font-bold">Inconsistent Identity:</span> The lack of a cohesive design language across
                the platform diluted brand presence and user trust.
              </li>
            </ul>
          </div>
        ...
        <section className="bg-[#222222] text-white py-14 md:py-16 mb-16 rounded-none">
          <div className="max-w-6xl mx-auto px-12 md:px-24">
            ...
            <p className="text-lg leading-relaxed mb-8 opacity-95">
              ...
              daily. This research phase yielded critical insights which became the foundation of our design strategy,
              highlighting a clear need for reusable components that would not only improve design consistency but also
              accelerate the development cycle.
            </p>
            <div className="grid md:grid-cols-3 gap-8">
              {insights.map(insight => <Insight key={insight.number} {...insight} />)}
            </div>
          </div>
        </section>
        ...
        <section className="px-12 md:px-24 my-16">
          ...
          <p className="text-lg leading-relaxed">
            ...
            business goals. My process was iterative and focused on validating the approach at each stage. With a clear
            understanding of the pain points, I moved into low-fidelity design. I developed wireframes that mapped out
            the core structure and key user flows of the redesigned application.
          </p>
          <p className="text-lg leading-relaxed mt-4">These wireframes focused on:</p>
          <ul className="list-disc list-inside text-lg leading-relaxed space-y-2 mt-4">
            <li><span className="font-bold">Information Architecture:</span> Restructuring the layout to create a logical hierarchy.</li>
            <li><span className="font-bold">Navigation Logic:</span> Simplifying the primary navigation to be task-oriented.</li>
            <li><span className="font-bold">User Flow Validation:</span> Outlining the ideal path for campaign creation and segmentation.</li>
          </ul>
          <p className="text-lg leading-relaxed mt-4">
            Presenting these early drafts to stakeholders and the development team allowed us to align on the core
            usability and functionality before committing to high-fidelity visuals, saving valuable time and resources.
          </p>
        ...
        <section className="bg-[#111827] text-white py-14 md:py-16">
          <div className="max-w-6xl mx-auto px-12 md:px-24">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {outcomes.map(outcome => <Outcome key={outcome.title} {...outcome}>{outcome.text}</Outcome>)}
            </div>
          </div>
        </section>
        ...
        <section className="relative px-12 md:px-24 my-16">
          ...
          <p className="text-lg leading-relaxed">
            ...
            guided user experience becomes. Achieving this was a result of early alignment with product and engineering,
            which proved essential for translating user needs into feasible solutions.
          </p>
          <div
