...
const WalkInFlow = () => {
    ...
    return (
        <section className="w-full max-w-[1160px] mx-auto px-5 py-[60px] md:py-24 font-ibm-plex">
                ...
                <div className="col-span-1 md:col-span-12">
                    ...
                    >
                        ...
                        <div className="w-full h-full p-8 flex items-center justify-center">
                            <img
                                src="/v2/images/projects/ramen-nagi/Ramen-Nagi---Walk-in-flow.png"
            ...
            <InteractiveImageModal
                ...
                imageSrc={"/v2/images/projects/ramen-nagi/Ramen-Nagi---Walk-in-flow.png"}
