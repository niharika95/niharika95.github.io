        ...
        <section className="w-full max-w-[1160px] mx-auto px-5 mb-[120px] md:mb-[200px]">
            <div className="w-full pt-[60px] md:pt-[100px] pb-0 bg-[#F5F5F5] text-[#111] text-center font-sans rounded-b-[40px] px-3 md:px-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 mb-24 max-w-4xl mx-auto relative relative-grid">
                    ...
                    >
                        <div className="mb-2">
                            <img src="/v2/images/projects/ramen-nagi/Reservation icon.png" alt="Reservation" className="w-20 h-20 object-contain" />
                        </div>
                    ...
                    >
                        <div className="mb-2">
                            <img src="/v2/images/projects/ramen-nagi/Walk-in icon.png" alt="Walk-in" className="w-20 h-20 object-contain" />
                        </div>
                ...
                >
                    <img
                        src="/v2/images/projects/ramen-nagi/Ramen-Nagi---3-phones.png"
