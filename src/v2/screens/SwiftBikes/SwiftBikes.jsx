    ...
    <div className='relative bg-white text-gray-900 font-ibm-plex'>
      ...
      <header className='w-full bg-[#FF980A]'>
        <ContentContainer className='relative flex flex-col md:flex-row'>
          ...
          <img
            src="/v2/images/projects/swiftbikes/swiftbikes.png"
      ...
      <main className='w-full'>
            ...
            <div className='flex flex-col gap-12'>
              ...
              <div>
                ...
                <div className='flex flex-col md:flex-row gap-4'>
                  <img src="/v2/images/projects/swiftbikes/swiftbikesPersona1Matthew.png" alt='Persona 1 - Matthew' className='w-full md:w-1/2 h-auto' />
                  <img src="/v2/images/projects/swiftbikes/swiftbikesPersona2Kate.png" alt='Persona 2 - Kate' className='w-full md:w-1/2 h-auto' />
                </div>
              </div>
            </div>
          </ContentContainer>
        ...
        <section className='w-full bg-[#f5f5f5] py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer>
            ...
            <img src="/v2/images/projects/swiftbikes/swiftbikesLofiWireframesMobile.png" alt='Mobile Wireframes' className='w-full h-auto mb-12' />
            
            <h3 className='font-playfair text-2xl font-bold mb-6'>Digital Wireframes - Desktop</h3>
            <img src="/v2/images/projects/swiftbikes/swiftbikesLofiWireframesDesktop.png" alt='Desktop Wireframes' className='w-full h-auto' />
          </ContentContainer>
        </section>
        ...
        <section className='py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer className='relative overflow-hidden'>
            ...
            <img src="/v2/images/projects/swiftbikes/swiftbikesHifiWireframesMobile.png" alt='Hi-Fi Mobile Screens' className='w-full h-auto mb-12' />
            
            <h3 className='font-playfair text-2xl font-bold mb-6'>Desktop Screens</h3>
            <img src="/v2/images/projects/swiftbikes/swiftbikesHifiWireframesDesktop.png" alt='Hi-Fi Desktop Screens' className='w-full h-auto' />
          </ContentContainer>
        </section>
