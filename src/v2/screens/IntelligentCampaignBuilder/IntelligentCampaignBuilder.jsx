...
const Insight = ({ number, text }) => (
  <div>
    ...
    <p className='font-ibm-plex text-lg leading-relaxed opacity-95'>{text}</p>
  </div>
);
...
const Result = ({ icon, title, children }) => (
  <div>
    ...
    <p className='font-ibm-plex opacity-95'>{children}</p>
  </div>
);
...
const IntelligentCampaignBuilder = () => {
  ...
  useAnalytics('project_detail', {
    projectName: 'intelligent-campaign-builder',
    ...
    <div className='relative bg-white text-gray-900 font-ibm-plex'>
      ...
      <header className='w-full bg-[#fb4e0b]'>
        <ContentContainer className='relative flex flex-col md:flex-row'>
          ...
          <img
            src='/v2/images/projects/intelligent-campaign-builder-overhaul/hero.png'
      ...
      <main className='w-full'>
          ...
          <ContentContainer>
            <div className='grid grid-cols-[auto,1fr] justify-start gap-x-4 gap-y-4 items-start'>
              ...
              <div className='col-start-1 flex items-center whitespace-nowrap'>
                ...
                />
                <h3 className='font-ibm-plex font-bold text-lg'>Team:</h3>
              </div>
              <p className='font-ibm-plex col-start-2 text-gray-600 text-lg'>
              ...
              <div className='col-start-1 flex items-center whitespace-nowrap'>
                <Icon
                  ...
                  className='text-2xl text-black mr-4'
                />
                <h3 className='font-ibm-plex font-bold text-lg'>Duration:</h3>
              </div>
              <p className='font-ibm-plex col-start-2 text-gray-600 text-lg'>6 months</p>
            </div>
          </ContentContainer>
        </section>
          ...
          <ContentContainer className='relative overflow-hidden'>
            ...
            <div className='flex flex-col gap-12'>
              <div>
                ...
                <p className='font-ibm-plex text-lg leading-relaxed mb-4 max-w-[800px]'>
                ...
                <ul className='font-ibm-plex list-disc list-inside text-lg leading-relaxed space-y-2 mt-4 max-w-[800px]'>
                  <li>
          ...
          <ContentContainer>
            <div className='grid md:grid-cols-3 gap-8 items-center'>
              ...
              <div className='md:col-span-2 grid gap-8'>
                <p className='font-ibm-plex text-lg md:text-xl leading-relaxed opacity-90'>
        ...
        <section className='bg-[#222222] text-white py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer>
            ...
            <p className='font-ibm-plex text-lg leading-relaxed mb-8 opacity-95'>
        ...
        <section className='w-full bg-[#222222] pt-5 md:pt-[50px] lg:pt-[100px] pb-0'>
          <ContentContainer>
            <div className='grid grid-cols-3 gap-[30px] items-end'>
              <img
                src='/v2/images/projects/intelligent-campaign-builder-overhaul/laying1.png'
                alt='Laying the Foundation Image 1'
                className='w-full h-auto object-cover'
              />
              <img
                src='/v2/images/projects/intelligent-campaign-builder-overhaul/laying2.png'
                alt='Laying the Foundation Image 2'
                className='w-full h-auto object-cover'
              />
              <img
                src='/v2/images/projects/intelligent-campaign-builder-overhaul/laying3.png'
        ...
        <section className='flex w-full bg-[#fb4e0b] text-white'>
          <ContentContainer className='py-5 md:py-[50px] lg:py-[100px]'>
            <div className='grid grid-cols-1 md:grid-cols-12 gap-8 items-center'>
              <img
                src='/v2/images/projects/intelligent-campaign-builder-overhaul/clarity1.png'
                alt='Clarity Design Image'
                className='w-full md:col-span-8'
              />
              <p className='font-ibm-plex text-md leading-relaxed md:col-span-4'>
        ...
        <section className='flex w-full bg-[#fb4e0b] text-white'>
          <ContentContainer className='py-5 md:py-[50px] lg:py-[100px]'>
            <div className='grid grid-cols-1 md:grid-cols-12 gap-8 items-center'>
              <img
                src='/v2/images/projects/intelligent-campaign-builder-overhaul/clarity2.png'
                alt='Clarity Design Image'
                className='w-full md:col-span-8'
              />
              <p className='font-ibm-plex text-md leading-relaxed md:col-span-4'>
        ...
        <section className='flex w-full bg-[#fb4e0b] text-white'>
          <ContentContainer className='py-5 md:py-[50px] lg:py-[100px]'>
            <div className='grid grid-cols-1 md:grid-cols-12 gap-8 items-center'>
              <img
                src='/v2/images/projects/intelligent-campaign-builder-overhaul/clarity3.png'
                alt='Clarity Design Image'
                className='w-full md:col-span-8'
              />
              <p className='font-ibm-plex text-md leading-relaxed md:col-span-4'>
        ...
        <section className='flex w-full bg-[#fb4e0b] text-white'>
          <ContentContainer className='py-5 md:py-[50px] lg:py-[100px]'>
            <div className='grid grid-cols-1 md:grid-cols-12 gap-8 items-center'>
              <img
                src='/v2/images/projects/intelligent-campaign-builder-overhaul/clarity4.png'
                alt='Clarity Design Image'
                className='w-full md:col-span-8'
              />
              <p className='font-ibm-plex text-md leading-relaxed md:col-span-4'>
        ...
        <section className='bg-[#222222] text-white py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer>
            ...
            <p className='font-ibm-plex text-lg leading-relaxed mb-8 opacity-95 max-w-[800px]'>
