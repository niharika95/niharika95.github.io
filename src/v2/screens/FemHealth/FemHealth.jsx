    ...
    <div className='relative bg-white text-gray-900 font-ibm-plex'>
      ...
      <header className='w-full bg-[#3E122D]'>
        <ContentContainer className='relative flex flex-col md:flex-row'>
          ...
          <img
            src="/v2/images/projects/femhealth/femhealth.png"
            alt='FemHealth Hero'
      ...
      <main className='w-full'>
            ...
            <div className='flex flex-col gap-12'>
              ...
              <div>
                ...
                <div className='flex flex-col md:flex-row gap-4'>
                  <img src="/v2/images/projects/femhealth/femhealthPersona1Julia.png" alt='Persona 1 - Julia' className='w-full md:w-1/2 h-auto' />
                  <img src="/v2/images/projects/femhealth/femhealthPersona2Eve.png" alt='Persona 2 - Eve' className='w-full md:w-1/2 h-auto' />
                </div>
              </div>
            </div>
          </ContentContainer>
        ...
        <section className='py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer className='relative overflow-hidden'>
            ...
            <img src="/v2/images/projects/femhealth/femhealthLofiWireframesDesktop.png" alt='Desktop Wireframes' className='w-full h-auto' />
          </ContentContainer>
        </section>
        ...
        <section className='w-full bg-[#f5f5f5] py-5 md:py-[50px] lg:py-[100px]'>
          <ContentContainer>
            ...
            <div className='flex flex-col gap-8'>
              <img src="/v2/images/projects/femhealth/femhealthHifiWireframesDesktop1.png" alt='Hi-Fi Desktop 1' className='w-full h-auto' />
              <img src="/v2/images/projects/femhealth/femhealthHifiWireframesDesktop2.png" alt='Hi-Fi Desktop 2' className='w-full h-auto' />
              <img src="/v2/images/projects/femhealth/femhealthHifiWireframesDesktop3.png" alt='Hi-Fi Desktop 3' className='w-full h-auto' />
              <img src="/v2/images/projects/femhealth/femhealthHifiWireframesDesktop4.png" alt='Hi-Fi Desktop 4' className='w-full h-auto' />
            </div>
            
            <h3 className='font-playfair text-2xl font-bold mt-12 mb-6'>Mobile and Tablet Screens</h3>
            <div className='flex flex-col md:flex-row gap-8'>
              <img src="/v2/images/projects/femhealth/femhealthHifiWireframesMobile.png" alt='Mobile Screens' className='w-full md:w-1/2 h-auto' />
              <img src="/v2/images/projects/femhealth/femhealthHifiWireframesTablet.png" alt='Tablet Screens' className='w-full md:w-1/2 h-auto' />
            </div>
          </ContentContainer>
        </section>
