    ...
    <div className='relative bg-white text-gray-900 font-ibm-plex'>
      ...
      <header className='w-full bg-[#1D5D82]'>
        <ContentContainer className='relative flex flex-col md:flex-row'>
          ...
          <img
            src="/v2/images/projects/svaasthya/svaasthya.png"
            alt='Svaasthya Hero'
            ...
            <div className='flex flex-col gap-12'>
              ...
              <div>
                ...
                <div className='flex flex-col md:flex-row gap-4'>
                  <img src="/v2/images/projects/svaasthya/svaasthyaPersona1Priya.png" alt='Persona 1 - Priya' className='w-full md:w-1/2 h-auto' />
                  <img src="/v2/images/projects/svaasthya/svaasthyaPersona2Rakesh.png" alt='Persona 2 - Rakesh' className='w-full md:w-1/2 h-auto' />
                </div>
              </div>
            </div>
          </ContentContainer>
