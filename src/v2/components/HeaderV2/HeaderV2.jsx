  ...
  return (
    <>
      ...
      <div className="fixed md:hidden bottom-5 left-5 right-5 bg-white rounded-[40px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] px-6 py-4 flex items-center justify-between z-[1000] border border-gray-100">
        <Link to="/v2/about" className={`text-[15px] font-light no-underline relative transition-colors duration-200 ${isAboutActive ? 'text-gray-900' : 'text-gray-500'}`}>
          About
        ...
        <Link to="/v2/resume" className={`text-[15px] font-light no-underline relative transition-colors duration-200 ${isResumeActive ? 'text-gray-900' : 'text-gray-500'}`}>
          Resume
